...
override_git_prompt_colors() {
  ...
  GIT_PROMPT_BRANCH=" ${GIT_PROMPT_BRANCH}"        # the git branch that is active in the current directory
  GIT_PROMPT_MASTER_BRANCH="${Magenta}${GIT_PROMPT_BRANCH}" # used if the git branch that is active in the current directory is $GIT_PROMPT_MASTER_BRANCHES
  ...
  GIT_PROMPT_UNTRACKED="${Orange}"       # the number of untracked files/dirs
  ...
  GIT_PROMPT_SYMBOLS_AHEAD="ﰵ ·"             # The symbol for "n versions ahead of origin"
  GIT_PROMPT_SYMBOLS_BEHIND="ﰬ ·"            # The symbol for "n versions behind of origin"
  GIT_PROMPT_SYMBOLS_PREHASH=":"            # Written before hash of commit, if no name could be found
  GIT_PROMPT_SYMBOLS_NO_REMOTE_TRACKING="${Orange}" # This symbol is written after the branch, if the branch is not tracked 
